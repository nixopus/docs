...
Nixopus connects to GitHub through a GitHub App you install on your account. This gives Nixopus access to your repositories so it can clone code at build time and receive webhooks for auto-deploy.
