...
Nixopus supports build-time and runtime environment variables. Build variables are injected during the Docker build. Runtime variables are passed to the container at startup.
